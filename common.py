...
from features.steps.rfss_controller import rc_logout
...
def open_webui_app(context, app_name):
    ...
    if not page.get_by_text("WARNING! THIS SYSTEM IS RESTRICTED TO AUTHORIZED USERS ONLY!").is_visible():
