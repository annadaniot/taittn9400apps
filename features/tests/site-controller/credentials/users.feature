...
@authentication.db @tait_p25sc.db
Feature: Site Controller - Users
  WebUI Testing for Users page

  Background: Logging and go to users page on Site Controller
  ...
  Scenario: Site Controller Users table sort Username in ASC as default
  ...
  Scenario Outline: Sort Site Controller Users table with column <column>
    Given There is at less '2' rows in the table
  ...
  Scenario Outline: Filter Site Controller Users table
